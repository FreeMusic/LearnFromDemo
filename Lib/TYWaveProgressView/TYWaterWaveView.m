...
- (void)setUp
{
    waterWaveHeight = self.frame.size.height/2;
    waterWaveWidth  = self.frame.size.width;
    _firstWaveColor = [UIColor colorWithRed:245/255.0f green:181/255.0f blue:78/255.0f alpha:1];
    _secondWaveColor = [UIColor colorWithRed:247/255.0 green:200/255.0 blue:68/255.0 alpha:1];
