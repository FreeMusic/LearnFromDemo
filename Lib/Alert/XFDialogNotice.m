...
- (void)addContentView
{
    ...
    UILabel *contentLabel = [[UILabel alloc] init];//中间的提示信息
    NSString *text = XFDialogRealValue(XFDialogNoticeText, [user objectForKey:@"message"]);
    ...
    contentLabel.font = XFDialogRealFont(XFDialogNoticeTextFontSize,XFDialogContentTextDefFontSize);//字体大小
