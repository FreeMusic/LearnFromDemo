...
-(void)addTopBar
{
    ...
    for (int i=0; i<count; i++)
    {
        ...
        [btn setTitleColor:[UIColor colorWithRed:230 / 255.0 green:103 / 255.0 blue:61/255.0 alpha:1.0] forState:UIControlStateSelected];
...
-(void)addVCView
{
    UIScrollView *contentView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0+44, DCScreenW, DCScreenH)];
    ...
    for (int i=0; i<count; i++) {
        ...
        vc.view.frame = CGRectMake(i*DCScreenW, 0, DCScreenW, DCScreenH -44-64-80*m6Scale);
        [contentView addSubview:vc.view];
    }
    contentView.contentSize = CGSizeMake(count*DCScreenW, DCScreenH);
