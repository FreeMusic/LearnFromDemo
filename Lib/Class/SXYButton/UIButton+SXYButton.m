...
//
/**
 *  此处按钮的防重复点击使用到了Runtime监听点击事件，需要导入头文件
 */

#import "UIButton+SXYButton.h"
#import "objc/runtime.h"
#define defaultInterval 1//此处设置默认的时间间隔
...
@implementation UIButton (SXYButton)
