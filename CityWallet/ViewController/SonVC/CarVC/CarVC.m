...
@interface CarVC ()<UITableViewDelegate, UITableViewDataSource, FactoryDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    static NSString *CarVC = @"CarVC";
    CityWalletCell *cell = [tableView dequeueReusableCellWithIdentifier:CarVC];
    if (!cell) {
        cell = [[CityWalletCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:CarVC];
    }
