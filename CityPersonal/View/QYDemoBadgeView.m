...
@implementation YSFDemoBadgeView

+ (instancetype)viewWithBadgeTip:(NSString *)badgeValue{
    if (!badgeValue) {
        badgeValue = @"";
    }
    YSFDemoBadgeView *instance = [[YSFDemoBadgeView alloc] init];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder])
    {
        ...
        _badgeTextFont        = [UIFont boldSystemFontOfSize:20*m6Scale];
